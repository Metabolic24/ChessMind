...
<div id="show-user" class="content scaffold-show" role="main">
    ...
    <ol class="property-list user">
        ...
        <g:if test="${userInstance?.problems}">
            <li class="fieldcontain">
                <span id="problems-label" class="property-label"><g:message code="user.problems.label"
                                                                            default="Problems"/></span>

                <g:each in="${userInstance.problems}" var="p">
                    <span class="property-value" aria-labelledby="problems-label"><g:link controller="problem"
                                                                                          action="show"
        ...
        <g:if test="${userInstance?.score}">
            <li class="fieldcontain">
                <span id="score-label" class="property-label"><g:message code="user.score.label"
                                                                         default="Score"/></span>

                <span class="property-value" aria-labelledby="score-label"><g:link controller="score" action="show"
                                                                                   id="${userInstance?.score?.id}">${userInstance?.score?.encodeAsHTML()}</g:link></span>
