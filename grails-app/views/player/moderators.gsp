    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="password"
                              title="${message(code: 'moderator.password.label', default: 'Password')}"/>

            <g:sortableColumn property="description"
                              title="${message(code: 'moderator.description.label', default: 'Description')}"/>
        ...
        <g:each in="${moderatorInstanceList}" status="i" var="moderatorInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${moderatorInstance.id}">${fieldValue(bean: moderatorInstance, field: "name")}</g:link></td>
