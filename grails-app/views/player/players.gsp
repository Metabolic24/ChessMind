    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="password"
                              title="${message(code: 'player.password.label', default: 'Password')}"/>

            <g:sortableColumn property="description"
                              title="${message(code: 'player.description.label', default: 'Description')}"/>
        ...
        <g:each in="${playerList}" status="i" var="playerInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${playerInstance.id}">${fieldValue(bean: playerInstance, field: "name")}</g:link></td>
